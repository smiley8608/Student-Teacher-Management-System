        ...
        <div className="tw-w-full tw-h-screen tw-bg-slate-300 tw-flex tw-justify-center tw-items-center ">
            <div className="lg:tw-w-3/12 md:tw-w-5/12 tw-p-6 tw-bg-slate-50 tw-rounded-lg tw-shadow-lg">
                <div className="tw-flex tw-justify-center ">
                    <div className="lg:tw-w-5/12 sm:tw-w-3/12 tw-h-32 tw-rounded-lg tw-border-black tw-border-2 tw-overflow-hidden tw-shadow-2xl tw-mt-2">

                <img src={`http://localhost:3002/${student?.path}`} alt="profilephoto" className="tw-rounded-lg tw-border-black tw-w-full tw-h-full tw-overflow-hidden " ></img>
                    </div>
                </div>
