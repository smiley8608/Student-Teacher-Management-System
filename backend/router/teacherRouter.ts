...
import { LeaveApproval, LeaveReject, LeaveResponce } from '../controllers/leave'
...
TeacherRouter.get('/leaveresponce',Middlewere,LeaveResponce)
TeacherRouter.post('/leaveapproval',Middlewere,LeaveApproval)
TeacherRouter.post('/rejecthandler',Middlewere,LeaveReject)
